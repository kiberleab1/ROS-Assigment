...
class RotationTranslationOutput {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RotationTranslationOutput(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RotationTranslationOutput(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
module.exports = RotationTranslationOutput;
